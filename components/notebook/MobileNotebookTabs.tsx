    ...
    <Tabs defaultValue="chat" className="flex-1 flex flex-col overflow-hidden">
      <TabsList className="grid w-full grid-cols-3 bg-gray-100 p-1 h-12 rounded-none border-b border-gray-200">
        ...
        >
          ...
          <span className="hidden sm:inline">{t('notebook.tabs.sources')}</span>
        </TabsTrigger>
        <TabsTrigger 
          value="chat" 
          className="flex items-center space-x-2 text-sm data-[state=active]:bg-white data-[state=active]:shadow-sm"
        >
          ...
          <span className="hidden sm:inline">{t('notebook.tabs.chat')}</span>
        </TabsTrigger>
        <TabsTrigger 
          value="studio" 
          className="flex items-center space-x-2 text-sm data-[state=active]:bg-white data-[state=active]:shadow-sm"
        >
          ...
          <span className="hidden sm:inline">{t('notebook.tabs.notes')}</span>
        </TabsTrigger>
      </TabsList>
