        ...
        <div className="p-4 border-b border-gray-200 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-medium text-gray-900">
              {isAIResponse ? t('notebook.studio.notes.aiResponse') : t('notebook.studio.notes.note')}
            </h3>
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-gray-200 flex-shrink-0">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-medium text-gray-900">
            {note ? t('notebook.studio.notes.editNote') : t('notebook.studio.notes.newNote')}
          </h3>
        ...
        <div className="flex space-x-2 mb-4">
          <Input
            placeholder={t('notebook.studio.notes.noteTitlePlaceholder')}
            value={title}
          ...
          {isAIResponse && (
            ...
            >
              ...
              {isGeneratingTitle ? t('notebook.studio.notes.generating') : t('notebook.studio.notes.generateTitle')}
            </Button>
          )}
        </div>
      </div>
      ...
      <div className="flex-1 p-4 overflow-hidden">
        <Textarea
          placeholder={t('notebook.studio.notes.writeNotePlaceholder')}
          value={content}
